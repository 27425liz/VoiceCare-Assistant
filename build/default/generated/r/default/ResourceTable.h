...
const int32_t MEDIA_STT = 0x01000009;
const int32_t MEDIA_TTS = 0x0100000a;
const int32_t MEDIA_BACKGROUND = 0x01000001;
const int32_t MEDIA_FOREGROUND = 0x01000002;
const int32_t MEDIA_HELP = 0x0100000b;
const int32_t MEDIA_LAYERED_IMAGE = 0x01000003;
const int32_t MEDIA_LOGO = 0x0100000c;
const int32_t MEDIA_SETTINGS = 0x0100000d;
